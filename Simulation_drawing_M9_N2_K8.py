...
V_MMSE_Local = data['V_MMSE_Local'].transpose((0,3,2,1))
V_MRC_Local = data['V_MRC_Local'].transpose((0,3,2,1))
...
#
# rate_centralized_mmse_predict = np.sum(rate_k_centralized_mmse_predict,1)   # 联邦学习计算的和速率
# rate_centralized_mmse = data['Ru_cf_k_MMSE_SUM1']                   # 集中式MMSE和速率
# rate_local_mmse = data['Ru_cf_k_MMSE_SUM']                               # 本地MMSE和速率
# rate_local_mrc =data['Ru_cf_k_MRC_SUM']                                # 本地MRC和速率

# 画图
text_str = r"$M = 2$, $K = 8$"
x_site = [23.698,24.566,30.413,31.267]
...
plt.text(15, 0.4, text_str, ha='center', va='center', fontsize=15, color='black')
